    ...
    <tr>
      ...
      <td>
        <div class="td-actions">
          <button class="btn btn-secondary btn-sm" onclick="openEditUser('${u.uid}')">Editar</button>
          <button class="btn btn-danger btn-sm" onclick="confirmDeleteUser('${u.uid}', '${u.username}')">Eliminar</button>
        </div>
      </td>
    </tr>`).join("")
}
